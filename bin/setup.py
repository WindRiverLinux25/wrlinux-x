...
Top Commit: {top_commit}"""
    ...
    def __set_recipelists_layers(self):
        ...
        wrlinux_recipelists = os.path.join(self.project_dir, 'layers/local', 'conf/wrlinux-recipelists.inc')
        lines = ['# DO NOT EDIT THIS FILE!\n']
        lines.append('# This file is automatically generated by setup.py\n')
        lines.append('# Set RECIPE_LIST_LAYERS_ORIG with all known layers\n')
        lines.append("RECIPE_LIST_LAYERS_ORIG = '%s'\n\n" % ' '.join(sorted(collections)))
        lines.append('# The RECIPE_LIST_LAYERS will be modified by other layers\n')
        lines.append("RECIPE_LIST_LAYERS = '${RECIPE_LIST_LAYERS_ORIG}'")

        with open(wrlinux_recipelists, 'w') as f:
            f.writelines(lines)

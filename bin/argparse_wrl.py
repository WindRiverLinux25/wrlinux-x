...
class Argparse_Wrl(Argparse_Setup):
    ...
    def add_setup_options(self):
        ...
        self.base_args.add_argument('--send-log', action='store_true', help='Agree to send setup log to windriver')
        self.base_args.add_argument('--log-mail', help='Specify user specific log mail (default WRL-build-feedback@windriver.com)')
